...
public class JOptionPaneArrays
{
    ...
    // Arrays 1D
    public static JPanel createJPanel(Component parentComponent, char[] matrix, String message)
    {
    ...
    public static JPanel createJPanel(Component parentComponent, int[] matrix, String message, boolean showText)
    {
        GridLayout gridLay = null;
        JLabel label = null;
        JPanel panel = null;
    ...
    public static JPanel createJPanel(Component parentComponent, float[] matrix, String message)
    {
        GridLayout gridLay = null;
        JLabel label = null;
        JPanel panel = null;
    ...
    public static JPanel createJPanel(Component parentComponent, String[] matrix, String message)
    {
        GridLayout gridLay = null;
        JLabel label = null;
        JPanel panel = null;
    ...
    public static JPanel createJPanel(Component parentComponent, int[][] matrix, String message, boolean showAsColors)
    {
        GridLayout gridLay = null;
        JLabel label = null;
        JPanel panel = null;
